...
#define MAXHeight [UIScreen mainScreen].bounds.size.height * 0.6
...
-(void)configureForSearchBar{
    ...
    self.searchBar.placeholder = @"Search City/Town";
...
-(void)SR_ColorSchemeDark{
    ...
    self.headerBackgroundColor  = [UIColor colorWithRed:89/255.0f green:108.0f/255 blue:190.0f/255 alpha:1.0];
